...
function EditProfile(props) {
    ...
    async function UpdateUser() {
        try {
            await axios.put(`http://localhost:3000/user/${editUser._id}`, editUser);
        } catch (error) {
            console.log(error);
        }
    }
                ...
                <div className="edit-wrapper">
                    <div className="edit-container">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                <input type="text" name="bio" className="form-control" placeholder="Add bio" defaultValue={editUser.bio} onChange={handleChange}
                                    required />
